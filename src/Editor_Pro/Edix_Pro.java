...
class Lamina extends JPanel {
    public Lamina() {
        ...
        color.addActionListener(new ActionListener() {
            ...
            @Override
            /*
             * Al presionar el botón de Color de tipo, abre una nueva con los posibles
             * colores.
             */
    ...
    private class elegir implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == arial)
                Area_Texto.setFont(new Font("Arial", Font.PLAIN, 14));
            if (e.getSource() == helvetica)
                Area_Texto.setFont(new Font("Helvetica", Font.PLAIN, 14));
            if (e.getSource() == georgia)
                Area_Texto.setFont(new Font("Georgia", Font.PLAIN, 14));
            if (e.getSource() == gill_sans)
                Area_Texto.setFont(new Font("Gill Sans", Font.PLAIN, 14));
            if (e.getSource() == calibri)
                Area_Texto.setFont(new Font("Calibri", Font.PLAIN, 14));
            if (e.getSource() == times)
                Area_Texto.setFont(new Font("Times New Roman", Font.PLAIN, 14));
