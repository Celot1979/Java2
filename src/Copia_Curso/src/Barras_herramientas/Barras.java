...
class marco extends JFrame {
    public marco() {
		...
		EventoColorFondo colorAzul = new  EventoColorFondo("Azul", Color.BLUE, new ImageIcon("/Users/danielgil/Desktop/Curso_Java/src/Barras_herramientas/BolaAzul.gif"));
		EventoColorFondo colorRojo = new  EventoColorFondo("Rojo", Color.RED, new ImageIcon("/Users/danielgil/Desktop/Curso_Java/src/Barras_herramientas/BolaRoja.gif"));
		EventoColorFondo colorVerde = new  EventoColorFondo("Verde", Color.GREEN, new ImageIcon("/Users/danielgil/Desktop/Curso_Java/src/Barras_herramientas/BolaVerde.gif"));
