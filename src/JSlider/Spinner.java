...
class Lamina extends JPanel{
	public Lamina() {
		...
		//miSpinner = new JSpinner();//Constructor para valores númericos
		String lista[]= GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames();// Para tener adisposición todas las fuentes del equipo
		
		miSpinner = new JSpinner(new SpinnerListModel(lista));
		Dimension d = new Dimension(200,20); // Dar tamaño al Spinner
