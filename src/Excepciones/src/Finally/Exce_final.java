...
public class Exce_final {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner entrada = new Scanner(System.in);
		System.out.println("Elige la opcion: /n1º Cuadrado/n2º  Rectángulo/n3º Triángulo/n4º Círculo");
		try {
		...
		//int entrada =Integer.parseInt(JOptionPane.showInputDialog("Elige la opcion: " + "1º Cuadrado " + "2º Rectángulo " + "3º Triángulo " + "4º Círculo: "));
