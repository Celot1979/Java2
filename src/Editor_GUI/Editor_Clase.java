...
class Lamina extends JPanel {
    ...
    public void configMenu(String titulo, String menu, String tipoLetra, int estilos, int tamanos) {
        ...
        if (menu == "fuente") {
            ...
            if (estilos == Font.BOLD)
                e.addActionListener(new StyledEditorKit.BoldAction());
            if (estilos == Font.ITALIC)
                e.addActionListener(new StyledEditorKit.ItalicAction());
        } else if (menu == "tamano") {
            tamano.add(e);
    ...
    public void configColor(String titulo, String menu) {
        ...
        if (menu == "Rojo")
            Rojo.addActionListener(new StyledEditorKit.ForegroundAction("azul", Color.RED));
        if (menu == "Amarillo")
            Amarillo.addActionListener(new StyledEditorKit.ForegroundAction("azul", Color.YELLOW));
