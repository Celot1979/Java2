...
class Lamina extends JPanel {
    ...
    public void configuraMenu(String rotulo, String menu, String tipoLetra, int estilos, int tamanos) {
        ...
        // elemMenu.addActionListener(new GestionaEventos(rotulo, menu,
        // tipoLetra,estilos,tamanos));
    }

    /*
     * public class GestionaEventos implements ActionListener {
     * GestionaEventos(String rotulo, String menu, String tipoLetra,int estilos, int
     * tamanos){ this.tipoLetra = tipoLetra; this.rotulo= rotulo; this.estilos=
     * estilos; this.tamanos= tamanos; }
     * 
     * @Override public void actionPerformed(ActionEvent e) { // TODO Auto-generated
     * method stub letraExistente= miArea.getFont(); if(rotulo == "Arial" ||rotulo
     * == "Courier" ||rotulo == "Verdana") { estilos = letraExistente.getStyle();
     * tamanos = letraExistente.getSize(); }else if(rotulo =="Cursiva" || rotulo ==
     * "Negrita") { if(letraExistente.getStyle() == 1 || letraExistente.getStyle()
     * == 2)estilos =3; tipoLetra =letraExistente.getFontName(); tamanos =
     * letraExistente.getSize();
     * 
     * }else if (rotulo =="12" || rotulo =="14"|| rotulo =="16") { tipoLetra
     * =letraExistente.getFontName(); estilos = letraExistente.getStyle(); }
     * miArea.setFont(new Font(tipoLetra,estilos,tamanos));
     * 
     * } String tipoLetra,rotulo; int estilos, tamanos; }
     */
    JTextPane miArea;
